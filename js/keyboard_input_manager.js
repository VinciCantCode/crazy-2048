...
KeyboardInputManager.prototype.listen = function () {
  ...
  var keyMap = {
    "ArrowUp": 0, "Up": 0, "w": 0, "W": 0, "k": 0, "K": 0,
    "ArrowRight": 1, "Right": 1, "d": 1, "D": 1, "l": 1, "L": 1,
    "ArrowDown": 2, "Down": 2, "s": 2, "S": 2, "j": 2, "J": 2,
    "ArrowLeft": 3, "Left": 3, "a": 3, "A": 3, "h": 3, "H": 3
  };
  ...
  var handleKeydown = function (event) {
    ...
    if (direction === undefined) {
      direction = directionMap[event.keyCode];
    }
    if (direction !== undefined) {
      event.preventDefault();
